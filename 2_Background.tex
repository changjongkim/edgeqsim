...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{Figures/edge_back2.png}
    ...
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{Figures/edge_back3.png}
