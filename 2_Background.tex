...
For example, simulating 30 qubits requires 16~GB of memory, which exceeds the 8~GB unified memory of a standard NVIDIA Jetson Orin Nano.
Furthermore, a 34-qubit simulation requires 256~GB, and a 39-qubit simulation demands 4~TB, far exceeding the physical DRAM capacity of any standalone edge system.
Consequently, simulating such large-scale circuits on edge devices necessitates utilizing secondary storage (NVMe SSDs) as an extension of main memory.
...
\begin{figure}[t]
    ...
    \caption{Memory hierarchy and data flow in edge computing architectures.}
