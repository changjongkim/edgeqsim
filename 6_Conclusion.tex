...
Our evaluations across various quantum circuits and scales show that \EdgeQuantum achieves up to 1.48$\times$ speedup over blocking I/O baselines, supports full state vector simulations up to 39 qubits (4~TB) on an 8~GB NVIDIA Jetson Orin Nano with up to 512$\times$ memory expansion, and successfully executes complex circuits such as 39-qubit Quantum Volume. 
