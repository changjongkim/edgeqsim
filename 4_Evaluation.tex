...
For all circuits up to 30 qubits (where verification is feasible), \EdgeQuantum at $T=8$ achieved measured state fidelities of $F \geq 0.9919$ across the six circuits, ranging from 0.9919 (QV) to 0.9998 (GHZ), confirming that the mantissa-truncated LZ4 compression/decompression cycle bounds the error within the truncation depth $T$.
