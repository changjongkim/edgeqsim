...
\subsection{Impact of number of UVM buffer}
...
\begin{figure}[!t]
    ...
    % --- (2) Subfigures side-by-side ---
    \subfloat[32 Qubit.]{
        \includegraphics[width=0.46\linewidth]{Figures/32buffer.png}
        \label{32qubit_buffer}
        \vspace{-.3cm}
    }
    \subfloat[36 Qubit.]{
        \includegraphics[width=0.46\linewidth]{Figures/36buffer.png}
        \label{36qubit_buffer}
            \vspace{-.3cm}
    }

        \vspace{-.2cm}
    % --- (3) Caption ---
    \caption{Comparison of average retrieval latency across tiers.}
    \vspace{-.2cm}
    \label{bufferimpact}
\end{figure}
