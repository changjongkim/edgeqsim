...
\centering
\scriptsize
\caption{Extreme-scale simulation times (seconds) for \EdgeQuantum with mantissa-truncated LZ4 compression at $T=6$ (Depth=5). Dash indicates configurations that exceed the 500GB SSD capacity in the dual-file ping-pong layout.}
\resizebox{\columnwidth}{!}{%
...
QSVM   & 251.49 & 493.84 & 981.47 & 1,979.51 & 3,970.93 \\
QV     & 632.96 & 1,318.59 & 2,611.45 & 5,298.55 & 10,520.62 \\
\hline
Random & 1,150.86 & 2,373.30 & --- & --- & --- \\
VQE    & 1,265.49 & 2,510.27 & --- & --- & --- \\
VQC    & 1,384.00 & 2,817.50 & --- & --- & --- \\
\hline
\end{tabular}%
}
...
As shown in the table, \EdgeQuantum exhibits stable, near-linear scalability as the state vector doubles at each qubit increment. For high-ratio circuits (GHZ, QSVM, QV), runtime tracks the 16$\times$ data volume growth, increasing 15.8$\times$$-$16.6$\times$ from 119.1s$-$633.0s at 35Q to 1,980.2s$-$10,520.6s at 39Q (e.g., 10,520.6s or $\approx$2.92 hours for QV). Dense circuits stop at 36Q within the 500GB capacity, with Random, VQE, and VQC completing 36Q in 2,373.3s, 2,510.3s, and 2,817.5s, respectively. This near 2$\times$ time growth per qubit confirms that the ping-pong pipeline maintains compression throughput at the 4~TB scale without degradation from queue contention or fragmentation.
...
\begin{table}[t]
\centering
\caption{I/O breakdown (seconds) for \EdgeQuantum with mantissa-truncated LZ4 ping-pong compression at $T=6$ across 34-36 qubits (Depth=5).}
\setlength{\tabcolsep}{3pt}
\scriptsize
\resizebox{\columnwidth}{!}{%
...
\hline
\multirow{3}{*}{34Q}
 & VQC & 121.9 & 226.9 & 12.6 & 84.1 & 288.0 & 733.5 \\
 & GHZ & 0.4 & 44.3 & 2.0 & 15.7 & 0.9 & 63.3 \\
 & VQE & 111.5 & 221.3 & 11.8 & 82.1 & 232.2 & 658.9 \\
\hline
\multirow{3}{*}{35Q}
 & VQC & 268.1 & 421.6 & 25.1 & 157.4 & 511.8 & 1384.0 \\
 & GHZ & 0.5 & 83.3 & 4.1 & 29.6 & 1.6 & 119.1 \\
 & VQE & 206.0 & 426.4 & 24.3 & 159.4 & 449.4 & 1265.5 \\
\hline
\multirow{3}{*}{36Q}
 & VQC & 555.6 & 856.7 & 50.9 & 320.9 & 1033.4 & 2817.5 \\
 & GHZ & 1.0 & 172.8 & 8.0 & 61.8 & 3.2 & 246.8 \\
 & VQE & 432.9 & 847.6 & 49.6 & 314.1 & 866.0 & 2510.3 \\
\hline
\end{tabular}%
}
